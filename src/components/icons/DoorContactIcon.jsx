...
const DoorContactIcon = ({ adjustedSize, isTierBox = false, tierType = 'normal' }) => {
    ...
    switch(tierType) {
      case 'cosmic':
        return {
          ...
          magnet: 'from-cyan-300 to-purple-300',
      ...
      case 'mega':
        return {
          ...
          magnet: 'from-red-300 to-purple-300',
      ...
      case 'super':
        return {
          ...
          magnet: 'from-yellow-300 to-orange-400',
      ...
      case 'standard':
        return {
          ...
          magnet: 'from-blue-300 to-cyan-300',
      ...
      default:
        return {
          ...
          magnet: 'from-gray-300 to-gray-500',
  ...
  return (
    ...
    >
      {/* Main sensor body */}
      <div
        className={`absolute top-2 left-2 bottom-2 bg-gradient-to-br ${colors.body} border-2 border-white/20 rounded-lg`}
        style={{
          width: baseSize * 0.4,
      ...
      {/* Magnet part */}
      <div
        className={`absolute top-2 right-2 bottom-2 bg-gradient-to-br ${colors.magnet} border-2 border-white/20 rounded-lg`}
        style={{
          width: baseSize * 0.35,
          boxShadow: 'inset 0 2px 4px rgba(255,255,255,0.2), 0 4px 8px rgba(0,0,0,0.3)'
        }}
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        {[...Array(3)].map((_, i) => (
          <motion.div
            ...
            style={{
              width: baseSize * (0.2 + i * 0.15),
              height: baseSize * (0.1 + i * 0.05),
              top: '50%',
              left: '50%',
      ...
      {/* Status LED */}
      <div
        className={`absolute top-2 left-1/2 transform -translate-x-1/2 w-2 h-2 rounded-full bg-gradient-to-br ${colors.accent} border border-white/20`}
        style={{
      ...
      {/* Wire indicator */}
      <div
        className={`absolute bottom-0 left-1/4 w-1 h-2 bg-gradient-to-b ${colors.accent} rounded-t`}
        style={{
...
export default DoorContactIcon; 